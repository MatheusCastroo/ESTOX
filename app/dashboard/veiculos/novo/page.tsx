...
export default function NewVehiclePage() {
  ...
  return (
    <>
      <DashboardHeader title="Novo Veículo" description="Cadastre um novo veículo no seu estoque" />
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <CardContent className="space-y-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input id="model" placeholder="Ex: Civic Touring" required />
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <Input id="mileage" type="number" placeholder="Ex: 50000" required />
                    </div>
                    <div>
                      <Label htmlFor="price">Preço (R$)</Label>
                      <Input id="price" type="number" placeholder="Ex: 150000" required />
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <Input id="color" placeholder="Ex: Prata" required />
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <Textarea placeholder="Descreva o veículo, condições, diferenciais..." className="min-h-[120px]" />
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="border-2 border-dashed border-[#E0E0E0] rounded-lg p-8 text-center">
                    <Upload className="h-10 w-10 mx-auto text-[#424242]/50 mb-3" />
                    <p className="text-sm text-[#424242]/70 mb-2">Arraste imagens ou clique para fazer upload</p>
