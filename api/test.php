...
$test = [
    ...
    'environment' => [
        ...
        'DB_PORT' => getenv('DB_PORT') ?: 'não configurado',
        'DB_NAME' => getenv('DB_NAME') ?: 'não configurado',
        'DB_USER' => getenv('DB_USER') ?: 'não configurado',
        'JWT_SECRET' => getenv('JWT_SECRET') ? 'configurado' : 'não configurado',
        'CORS_ORIGINS' => getenv('CORS_ORIGINS') ?: 'não configurado',
    ],
    'extensions' => [
